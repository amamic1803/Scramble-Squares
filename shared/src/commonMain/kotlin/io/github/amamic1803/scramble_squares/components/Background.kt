...
@Composable
@Preview
fun Background(dark: Boolean = isSystemInDarkTheme(), content: @Composable BoxScope.() -> Unit = {}) {
    val texture = if (dark) imageResource(Res.drawable.wood_dark) else imageResource(Res.drawable.wood_light)
